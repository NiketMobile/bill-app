...
const EditDisability = () => {
    ...
    useEffect(() => {
        dispatch(getCollectionAction({ collectionName: "Disability" }));
    }, [])
    ...
    const getData = async () => {
        ...
        try {
            ...
            if (userDoc?.person_disability) {
                setSelectedId(userDoc?.person_disability);
            }
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={{ marginTop: scale(5) }}>
                        ...
                        <Text style={styles.title}>Do you identify as a person with a disability?</Text>
                        <View style={{ flex: 1 }}>
                            <FlatList
                                showsVerticalScrollIndicator={false}

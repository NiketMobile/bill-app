...
const EditVeteran = () => {
    ...
    const getData = async () => {
        ...
        try {
            ...
            const response = userDoc?.veteran_id;

            if (response) {
                setSelectedId(userDoc.veteran_id);
            }
    ...
    const isValid = () => {
        ...
        if (!selectedId) {
            ...
            showToast({
                type: 'error',
                title: 'Select Veteran, is required',
            });
            ...
            <View style={styles.container}>
                ...
                >
                    <View style={{ marginTop: scale(5) }}>
                        ...
                        <Text style={styles.title}>Are you a veteran</Text>
                        <View style={{ flex: 1 }}>
                            <FlatList
                                showsVerticalScrollIndicator={false}
